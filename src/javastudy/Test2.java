...
public class Test2 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i <= 2; i++) {
            ...
            Test.scores[i] = scanner.nextInt();
        }

        System.out.println(a1.name + "의 점수는 " + Test.scores[0]);
        System.out.println(a2.name + "의 점수는 " + Test.scores[1]);
        System.out.println(a3.name + "의 점수는 " + Test.scores[2]);
    }
}
